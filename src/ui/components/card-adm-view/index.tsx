...
const posts = [
  ...
  },
  {
    ...
    author: 'Prof. Jane Doe',
    date: '22 de maio de 2024',
    content: 'lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec odio vitae nunc. lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec odio vitae nunc. lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec odio vitae nunc.',
  }
];
...
const CardAdmView = () => {
  return (
    <div className="container mx-auto p-4 grid grid-cols-2 gap-4">
      {posts.map((post) => (
        <Card key={post.id} className="relative flex flex-col" style={{ height: '270px', boxShadow: '0px 4px 4px 0px rgba(0, 0, 0, 0.25)' }}>
          ...
          <CardFooter className="absolute bottom-0 left-0 right-0 flex justify-between items-center p-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger>
                <Ellipsis color='white' className='p-1 bg-zinc-900 hover:bg-zinc-500 rounded-full'/>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
